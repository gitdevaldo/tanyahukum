  ...
  return (
    <section className="bg-light-cream px-[5%] py-14 sm:py-24">
      <div className="mx-auto max-w-[1400px]">
        <SectionHeading title="Legal Research + AI Tools Lebih Murah dari Konsultasi Pengacara" />
          ...
          <div className="grid grid-cols-1 items-center gap-8 sm:gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-2 text-neutral-gray">
                Unlimited analisis kontrak + akses database hukum
              </p>
            </div>
            <div>
